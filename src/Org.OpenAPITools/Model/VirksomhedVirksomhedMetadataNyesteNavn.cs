...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Virksomhed_virksomhedMetadata_nyesteNavn")]
    public partial class VirksomhedVirksomhedMetadataNyesteNavn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedMetadataNyesteNavn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VirksomhedVirksomhedMetadataNyesteNavn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedMetadataNyesteNavn" /> class.
        /// </summary>
        /// <param name="navn">Navn på entitet  (required).</param>
        ...
        public VirksomhedVirksomhedMetadataNyesteNavn(string navn = default(string), Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            // to ensure "navn" is required (not null)
            if (navn == null)
            {
                throw new ArgumentNullException("navn is a required property for VirksomhedVirksomhedMetadataNyesteNavn and cannot be null");
            }
            this.Navn = navn;
            // to ensure "periode" is required (not null)
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for VirksomhedVirksomhedMetadataNyesteNavn and cannot be null");
            }
            this.Periode = periode;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for VirksomhedVirksomhedMetadataNyesteNavn and cannot be null");
            }
        ...
        /// Navn på entitet 
        /// </summary>
        /// <value>Navn på entitet </value>
        /// <example>Daniel Nielsen</example>
        [DataMember(Name = "navn", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirksomhedVirksomhedMetadataNyesteNavn {\n");
