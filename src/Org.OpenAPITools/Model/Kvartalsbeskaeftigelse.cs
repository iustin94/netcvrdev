...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Kvartalsbeskaeftigelse")]
    public partial class Kvartalsbeskaeftigelse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Kvartalsbeskaeftigelse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Kvartalsbeskaeftigelse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Kvartalsbeskaeftigelse" /> class.
        /// </summary>
        ...
        public Kvartalsbeskaeftigelse(long aar = default(long), long? antalAarsvaerk = default(long?), long? antalAnsatte = default(long?), string intervalKodeAntalAarsvaerk = default(string), string intervalKodeAntalAnsatte = default(string), int kvartal = default(int), string sidstOpdateret = default(string))
        {
            this.Aar = aar;
            // to ensure "antalAarsvaerk" is required (not null)
            if (antalAarsvaerk == null)
            {
                throw new ArgumentNullException("antalAarsvaerk is a required property for Kvartalsbeskaeftigelse and cannot be null");
            }
            this.AntalAarsvaerk = antalAarsvaerk;
            // to ensure "antalAnsatte" is required (not null)
            if (antalAnsatte == null)
            {
                throw new ArgumentNullException("antalAnsatte is a required property for Kvartalsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAarsvaerk is a required property for Kvartalsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAnsatte is a required property for Kvartalsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Kvartalsbeskaeftigelse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Kvartalsbeskaeftigelse {\n");
