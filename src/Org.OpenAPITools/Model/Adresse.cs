...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Adresse : IValidatableObject
    {
        ...
        public Adresse(string adresseId = default(string), string bogstavFra = default(string), string bogstavTil = default(string), string bynavn = default(string), string conavn = default(string), string etage = default(string), string fritekst = default(string), int? husnummerFra = default(int?), int? husnummerTil = default(int?), AdresseKommune kommune = default(AdresseKommune), string landekode = default(string), Periode periode = default(Periode), string postboks = default(string), string postdistrikt = default(string), int? postnummer = default(int?), string sidedoer = default(string), string sidstOpdateret = default(string), DateTime? sidstValideret = default(DateTime?), int? vejkode = default(int?), string vejnavn = default(string))
        {
            // to ensure "bogstavFra" is required (not null)
            if (bogstavFra == null)
            {
                throw new ArgumentNullException("bogstavFra is a required property for Adresse and cannot be null");
            }
            this.BogstavFra = bogstavFra;
            // to ensure "bogstavTil" is required (not null)
            if (bogstavTil == null)
            {
                throw new ArgumentNullException("bogstavTil is a required property for Adresse and cannot be null");
            }
            this.BogstavTil = bogstavTil;
            // to ensure "bynavn" is required (not null)
            if (bynavn == null)
            {
                throw new ArgumentNullException("bynavn is a required property for Adresse and cannot be null");
            }
            this.Bynavn = bynavn;
            // to ensure "conavn" is required (not null)
            if (conavn == null)
            {
                throw new ArgumentNullException("conavn is a required property for Adresse and cannot be null");
            }
            this.Conavn = conavn;
            // to ensure "etage" is required (not null)
            if (etage == null)
            {
                throw new ArgumentNullException("etage is a required property for Adresse and cannot be null");
            }
            this.Etage = etage;
            // to ensure "fritekst" is required (not null)
            if (fritekst == null)
            {
                throw new ArgumentNullException("fritekst is a required property for Adresse and cannot be null");
            }
            this.Fritekst = fritekst;
            // to ensure "husnummerFra" is required (not null)
            if (husnummerFra == null)
            {
                throw new ArgumentNullException("husnummerFra is a required property for Adresse and cannot be null");
            }
            this.HusnummerFra = husnummerFra;
            // to ensure "husnummerTil" is required (not null)
            if (husnummerTil == null)
            {
                throw new ArgumentNullException("husnummerTil is a required property for Adresse and cannot be null");
            }
            this.HusnummerTil = husnummerTil;
            // to ensure "kommune" is required (not null)
            if (kommune == null)
            {
                throw new ArgumentNullException("kommune is a required property for Adresse and cannot be null");
            }
            this.Kommune = kommune;
            // to ensure "landekode" is required (not null)
            if (landekode == null)
            {
                throw new ArgumentNullException("landekode is a required property for Adresse and cannot be null");
            }
            this.Landekode = landekode;
            // to ensure "periode" is required (not null)
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for Adresse and cannot be null");
            }
            this.Periode = periode;
            // to ensure "postboks" is required (not null)
            if (postboks == null)
            {
                throw new ArgumentNullException("postboks is a required property for Adresse and cannot be null");
            }
            this.Postboks = postboks;
            // to ensure "postdistrikt" is required (not null)
            if (postdistrikt == null)
            {
                throw new ArgumentNullException("postdistrikt is a required property for Adresse and cannot be null");
            }
            this.Postdistrikt = postdistrikt;
            // to ensure "postnummer" is required (not null)
            if (postnummer == null)
            {
                throw new ArgumentNullException("postnummer is a required property for Adresse and cannot be null");
            }
            this.Postnummer = postnummer;
            // to ensure "sidedoer" is required (not null)
            if (sidedoer == null)
            {
                throw new ArgumentNullException("sidedoer is a required property for Adresse and cannot be null");
            }
            this.Sidedoer = sidedoer;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Adresse and cannot be null");
            }
            this.SidstOpdateret = sidstOpdateret;
            // to ensure "vejkode" is required (not null)
            if (vejkode == null)
            {
                throw new ArgumentNullException("vejkode is a required property for Adresse and cannot be null");
            }
            this.Vejkode = vejkode;
            // to ensure "vejnavn" is required (not null)
            if (vejnavn == null)
            {
                throw new ArgumentNullException("vejnavn is a required property for Adresse and cannot be null");
            }
