...
{
    /// <summary>
    ///  Class for testing AutentificeringApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class AutentificeringApiTests : IDisposable
    {
        private AutentificeringApi instance;

        public AutentificeringApiTests()
        {
            instance = new AutentificeringApi();
        }
        ...
        /// <summary>
        /// Test an instance of AutentificeringApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' AutentificeringApi
            //Assert.IsType<AutentificeringApi>(instance);
        }
        ...
        /// </summary>
        [Fact]
        public void TestAPIKeyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.TestAPIKey();
            //Assert.IsType<TestAPIKey200Response>(response);
        }
    }
}
