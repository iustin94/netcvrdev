...
{
    /// <summary>
    /// VirksomhedVirksomhedsstatusInner
    /// </summary>
    [DataContract(Name = "Virksomhed_virksomhedsstatus_inner")]
    public partial class VirksomhedVirksomhedsstatusInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedsstatusInner" /> class.
        /// </summary>
        /// <param name="periode">periode.</param>
        /// <param name="sidstOpdateret">Seneste tidspunkt hvor dette objekt blev opdateret .</param>
        /// <param name="status">status.</param>
        public VirksomhedVirksomhedsstatusInner(Periode periode = default(Periode), string sidstOpdateret = default(string), string status = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirksomhedVirksomhedsstatusInner {\n");
