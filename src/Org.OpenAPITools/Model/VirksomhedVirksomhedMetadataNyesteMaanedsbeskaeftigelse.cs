...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Virksomhed_virksomhedMetadata_nyesteMaanedsbeskaeftigelse")]
    public partial class VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse" /> class.
        /// </summary>
        ...
        public VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse(long aar = default(long), decimal? antalAarsvaerk = default(decimal?), long? antalAnsatte = default(long?), string intervalKodeAntalAarsvaerk = default(string), string intervalKodeAntalAnsatte = default(string), int maaned = default(int), string sidstOpdateret = default(string))
        {
            this.Aar = aar;
            // to ensure "antalAarsvaerk" is required (not null)
            if (antalAarsvaerk == null)
            {
                throw new ArgumentNullException("antalAarsvaerk is a required property for VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse and cannot be null");
            }
            this.AntalAarsvaerk = antalAarsvaerk;
            // to ensure "antalAnsatte" is required (not null)
            if (antalAnsatte == null)
            {
                throw new ArgumentNullException("antalAnsatte is a required property for VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAarsvaerk is a required property for VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAnsatte is a required property for VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirksomhedVirksomhedMetadataNyesteMaanedsbeskaeftigelse {\n");
