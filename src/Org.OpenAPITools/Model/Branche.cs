...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Branche")]
    public partial class Branche : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Branche" /> class.
        /// </summary>
        ...
        public Branche(string branchekode = default(string), string branchetekst = default(string), Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            // to ensure "branchekode" is required (not null)
            if (branchekode == null)
            {
                throw new ArgumentNullException("branchekode is a required property for Branche and cannot be null");
            }
            this.Branchekode = branchekode;
            // to ensure "branchetekst" is required (not null)
            if (branchetekst == null)
            {
                throw new ArgumentNullException("branchetekst is a required property for Branche and cannot be null");
            }
            this.Branchetekst = branchetekst;
            // to ensure "periode" is required (not null)
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for Branche and cannot be null");
            }
            this.Periode = periode;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Branche and cannot be null");
            }
