...
namespace Org.OpenAPITools.Model
{
    ...
    /// Livsforloeb
    /// </summary>
    [DataContract(Name = "Livsforloeb")]
    public partial class Livsforloeb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Livsforloeb" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Livsforloeb() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Livsforloeb" /> class.
        /// </summary>
        ...
        public Livsforloeb(Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            ...
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for Livsforloeb and cannot be null");
            }
            this.Periode = periode;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Livsforloeb and cannot be null");
            }
