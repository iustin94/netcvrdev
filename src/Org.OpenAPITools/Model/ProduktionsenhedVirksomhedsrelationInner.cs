...
{
    /// <summary>
    /// ProduktionsenhedVirksomhedsrelationInner
    /// </summary>
    [DataContract(Name = "Produktionsenhed_virksomhedsrelation_inner")]
    public partial class ProduktionsenhedVirksomhedsrelationInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProduktionsenhedVirksomhedsrelationInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProduktionsenhedVirksomhedsrelationInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProduktionsenhedVirksomhedsrelationInner" /> class.
        /// </summary>
        /// <param name="cvrNummer">cvrNummer (required).</param>
        ...
        public ProduktionsenhedVirksomhedsrelationInner(long cvrNummer = default(long), Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            this.CvrNummer = cvrNummer;
            // to ensure "periode" is required (not null)
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for ProduktionsenhedVirksomhedsrelationInner and cannot be null");
            }
            this.Periode = periode;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for ProduktionsenhedVirksomhedsrelationInner and cannot be null");
            }
            this.SidstOpdateret = sidstOpdateret;
        }

        /// <summary>
        /// Gets or Sets CvrNummer
        /// </summary>
        /// <example>10103940</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProduktionsenhedVirksomhedsrelationInner {\n");
