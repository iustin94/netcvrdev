...
{
    /// <summary>
    /// VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse
    /// </summary>
    [DataContract(Name = "Virksomhed_virksomhedMetadata_nyesteAarsbeskaeftigelse")]
    public partial class VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse" /> class.
        /// </summary>
        ...
        public VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse(int aar = default(int), int? antalAarsvaerk = default(int?), int? antalAnsatte = default(int?), int? antalInklusivEjere = default(int?), string intervalKodeAntalAarsvaerk = default(string), string intervalKodeAntalAnsatte = default(string), string intervalKodeAntalInklusivEjere = default(string), string sidstOpdateret = default(string))
        {
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAarsvaerk is a required property for VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAnsatte is a required property for VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalInklusivEjere is a required property for VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirksomhedVirksomhedMetadataNyesteAarsbeskaeftigelse {\n");
