...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Maanedsbeskaeftigelse")]
    public partial class Maanedsbeskaeftigelse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Maanedsbeskaeftigelse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Maanedsbeskaeftigelse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Maanedsbeskaeftigelse" /> class.
        /// </summary>
        ...
        public Maanedsbeskaeftigelse(long aar = default(long), decimal? antalAarsvaerk = default(decimal?), long? antalAnsatte = default(long?), string intervalKodeAntalAarsvaerk = default(string), string intervalKodeAntalAnsatte = default(string), int maaned = default(int), string sidstOpdateret = default(string))
        {
            this.Aar = aar;
            // to ensure "antalAarsvaerk" is required (not null)
            if (antalAarsvaerk == null)
            {
                throw new ArgumentNullException("antalAarsvaerk is a required property for Maanedsbeskaeftigelse and cannot be null");
            }
            this.AntalAarsvaerk = antalAarsvaerk;
            // to ensure "antalAnsatte" is required (not null)
            if (antalAnsatte == null)
            {
                throw new ArgumentNullException("antalAnsatte is a required property for Maanedsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAarsvaerk is a required property for Maanedsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("intervalKodeAntalAnsatte is a required property for Maanedsbeskaeftigelse and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Maanedsbeskaeftigelse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Maanedsbeskaeftigelse {\n");
