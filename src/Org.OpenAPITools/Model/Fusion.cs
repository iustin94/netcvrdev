...
namespace Org.OpenAPITools.Model
{
    ...
    /// Fusion
    /// </summary>
    [DataContract(Name = "Fusion")]
    public partial class Fusion : IValidatableObject
    {
        /// <summary>
        ...
        public Fusion(long enhedsNummerOrganisation = default(long), List<Attribut> indgaaende = default(List<Attribut>), List<Navn> organisationsNavn = default(List<Navn>), List<Attribut> udgaaende = default(List<Attribut>))
        {
