...
namespace Org.OpenAPITools.Model
{
    ...
    /// Kontaktoplysning
    /// </summary>
    [DataContract(Name = "Kontaktoplysning")]
    public partial class Kontaktoplysning : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Kontaktoplysning" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Kontaktoplysning() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Kontaktoplysning" /> class.
        /// </summary>
        /// <param name="hemmelig">hemmelig (required).</param>
        /// <param name="varKontaktoplysning">Kan indeholde enhver form for kontaktoplysning, e.g. email adresse, telefonnummer, postadresse.  (required).</param>
        ...
        public Kontaktoplysning(bool hemmelig = default(bool), string varKontaktoplysning = default(string), Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            this.Hemmelig = hemmelig;
            // to ensure "varKontaktoplysning" is required (not null)
            if (varKontaktoplysning == null)
            {
                throw new ArgumentNullException("varKontaktoplysning is a required property for Kontaktoplysning and cannot be null");
            }
            this.VarKontaktoplysning = varKontaktoplysning;
            // to ensure "periode" is required (not null)
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for Kontaktoplysning and cannot be null");
            }
            this.Periode = periode;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Kontaktoplysning and cannot be null");
            }
            this.SidstOpdateret = sidstOpdateret;
        }

        /// <summary>
        /// Gets or Sets Hemmelig
        /// </summary>
        /// <example>true</example>
        [DataMember(Name = "hemmelig", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <example>name@domain.tld</example>
        [DataMember(Name = "kontaktoplysning", IsRequired = true, EmitDefaultValue = true)]
        public string VarKontaktoplysning { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Kontaktoplysning {\n");
            sb.Append("  Hemmelig: ").Append(Hemmelig).Append("\n");
            sb.Append("  VarKontaktoplysning: ").Append(VarKontaktoplysning).Append("\n");
