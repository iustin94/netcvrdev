...
{
    /// <summary>
    /// VirksomhedDeltagerRelationInner
    /// </summary>
    [DataContract(Name = "Virksomhed_deltagerRelation_inner")]
    public partial class VirksomhedDeltagerRelationInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedDeltagerRelationInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VirksomhedDeltagerRelationInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VirksomhedDeltagerRelationInner" /> class.
        /// </summary>
        ...
        public VirksomhedDeltagerRelationInner(VirksomhedDeltagerRelationInnerDeltager deltager = default(VirksomhedDeltagerRelationInnerDeltager), List<Kontorsted> kontorsteder = default(List<Kontorsted>), List<Organisation> organisationer = default(List<Organisation>))
        {
            // to ensure "deltager" is required (not null)
            if (deltager == null)
            {
                throw new ArgumentNullException("deltager is a required property for VirksomhedDeltagerRelationInner and cannot be null");
            }
            this.Deltager = deltager;
            // to ensure "organisationer" is required (not null)
            if (organisationer == null)
            {
                throw new ArgumentNullException("organisationer is a required property for VirksomhedDeltagerRelationInner and cannot be null");
            }
        ...
        public VirksomhedDeltagerRelationInnerDeltager Deltager { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VirksomhedDeltagerRelationInner {\n");
