...
namespace Org.OpenAPITools.Model
{
    ...
    /// Navn
    /// </summary>
    [DataContract(Name = "Navn")]
    public partial class Navn : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Navn" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="Navn" /> class.
        /// </summary>
        /// <param name="varNavn">Navn på entitet  (required).</param>
        ...
        public Navn(string varNavn = default(string), Periode periode = default(Periode), string sidstOpdateret = default(string))
        {
            // to ensure "varNavn" is required (not null)
            if (varNavn == null)
            {
                throw new ArgumentNullException("varNavn is a required property for Navn and cannot be null");
            }
            this.VarNavn = varNavn;
            // to ensure "periode" is required (not null)
            if (periode == null)
            {
                throw new ArgumentNullException("periode is a required property for Navn and cannot be null");
            }
            this.Periode = periode;
            // to ensure "sidstOpdateret" is required (not null)
            if (sidstOpdateret == null)
            {
                throw new ArgumentNullException("sidstOpdateret is a required property for Navn and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarNavn: ").Append(VarNavn).Append("\n");
